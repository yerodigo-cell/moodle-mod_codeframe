...
$string['finish_btn_close']        = 'Volver al curso';
$string['finish_close_auto']       = 'Esta pestaña debería cerrarse automáticamente.';
$string['finish_error_desc']       = 'La actividad ya fue procesada o la sesión expiró.';
$string['finish_error_title']      = 'Atención';
$string['finish_success_desc']     = 'Tu progreso se ha guardado en Moodle.';
$string['finish_success_title']    = '¡Actividad completada exitosamente!';
