...
$string['finish_btn_close']                = 'Return to course';
$string['finish_close_auto']               = 'This tab should close automatically.';
$string['finish_error_desc']               = 'The activity was already processed or your session expired.';
$string['finish_error_title']              = 'Attention';
$string['finish_success_desc']             = 'Your progress has been saved in Moodle.';
$string['finish_success_title']            = 'Activity completed successfully!';
...
$string['privacy:metadata:codeframe_time'] = 'Information about the time spent by the student in the interactive activity.';
$string['privacy:metadata:codeframe_time:userid'] = 'The ID of the user who spent time in the activity.';
$string['privacy:metadata:codeframe_time:time_started'] = 'The timestamp when the user first started the activity.';
$string['privacy:metadata:codeframe_time:last_ping'] = 'The timestamp of the user\'s last activity ping.';
$string['privacy:metadata:codeframe_time:total_duration'] = 'The total time (in seconds) the user spent in the activity.';
$string['privacy:metadata:codeframe_time:last_session_duration'] = 'The time spent in the last session.';
